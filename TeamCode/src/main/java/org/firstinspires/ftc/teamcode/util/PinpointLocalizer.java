...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parY = -156.0; // y position of the parallel encoder (in millimeters)
        public double perpX = 112.0; // x position of the perpendicular encoder (in millimeters)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, Pose2d initialPose) {
        ...
        driver.setOffsets(PARAMS.parY, PARAMS.perpX);
